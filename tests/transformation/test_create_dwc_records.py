...
def test_remove_unidentified(deployments, images):
    result = create_dwc_records(
        images,
        deployments,
        remove_unidentified=True,
        remove_unidentified_kws={"rank": "family"},
    )
    expected = pd.DataFrame(
        {
            "occurrenceID": [np.nan, np.nan, np.nan],
            ...
            "collectionCode": [np.nan, np.nan, np.nan],
            "catalogNumber": [np.nan, np.nan, np.nan],
            "occurrenceRemarks": [np.nan, np.nan, np.nan],
            "recordNumber": ["a19bbd16", "740e09f5", "e09axa3q"],
            "recordedBy": ["Joe Bloggs", np.nan, "Joe Bloggs"],
            "organismID": [np.nan, np.nan, np.nan],
            "organismQuantity": [2.0, 1.0, 2.0],
            "organismQuantityType": ["individuals", "individuals", "individuals"],
            "sex": ["unknown", "male", "unknown"],
            "lifeStage": ["adult", np.nan, "adult"],
            "preparations": ["photograph", "photograph", "photograph"],
            "eventDate": ["2021-01-12", "2020-11-17", "2021-01-12"],
            "eventTime": ["09:59:02", "01:12:57", "09:59:03"],
            "identifiedBy": ["Jane Doe", "John Doe", "Jane Doe"],
            "dateIdentified": [np.nan, np.nan, np.nan],
            "identificationRemarks": [np.nan, np.nan, np.nan],
            "scientificNameID": ["32c0147f", "523439f4", "32c0147f"],
            ...
            "family": ["Cuniculidae", "Cricetidae", "Cuniculidae"],
            "genus": ["Cuniculus", np.nan, "Cuniculus"],
            "specificEpithet": ["paca", np.nan, "paca"],
            "infraspecificEpithet": ["nelsoni", np.nan, "nelsoni"],
            "taxonRank": ["subspecies", "family", "subspecies"],
            "scientificNameAuthorship": [np.nan, np.nan, np.nan],
            "vernacularName": ["Spotted Paca", "Cricetidae Family", "Spotted Paca"],
            "accessRights": ["CC-BY-NC", "CC-BY-NC", "CC-BY-NC"],
            "associatedMedia": ["gs:/a19.JPG", "gs:/740.JPG", "gs:/e09.JPG"],
        }
    )
    pd.testing.assert_frame_equal(result, expected)


def test_remove_duplicates(deployments, images):
    result = create_dwc_records(images, deployments, remove_duplicates=True)
    expected = pd.DataFrame(
        {
            "occurrenceID": [np.nan, np.nan, np.nan, np.nan],
            "parentEventID": ["90210", "90210", "90210", "90210"],
            "eventID": ["001", "001", "001", "002"],
            "basisOfRecord": [
                "MachineObservation",
                "MachineObservation",
                "MachineObservation",
            ...
            "institutionCode": [np.nan, np.nan, np.nan, np.nan],
            "collectionCode": [np.nan, np.nan, np.nan, np.nan],
            "catalogNumber": [np.nan, np.nan, np.nan, np.nan],
            "occurrenceRemarks": [np.nan, np.nan, np.nan, np.nan],
            "recordNumber": ["bc6534f0", "003cb8eb", "a19bbd16", "740e09f5"],
            "recordedBy": ["Joe Bloggs", "Joe Bloggs", "Joe Bloggs", np.nan],
            "organismID": [np.nan, np.nan, np.nan, np.nan],
            "organismQuantity": [np.nan, np.nan, 2, 1],
            "organismQuantityType": [np.nan, np.nan, "individuals", "individuals"],
            "sex": [np.nan, np.nan, "unknown", "male"],
            "lifeStage": [np.nan, np.nan, "adult", np.nan],
            "preparations": ["photograph", "photograph", "photograph", "photograph"],
            "eventDate": ["2020-12-13", "2020-12-25", "2021-01-12", "2020-11-17"],
            "eventTime": ["09:04:50", "10:23:12", "09:59:02", "01:12:57"],
            "identifiedBy": ["John Doe", "Jane Doe", "Jane Doe", "John Doe"],
            "dateIdentified": [np.nan, np.nan, np.nan, np.nan],
            ...
            "order": [np.nan, np.nan, "Rodentia", "Rodentia"],
            "family": [np.nan, np.nan, "Cuniculidae", "Cricetidae"],
            "genus": [np.nan, np.nan, "Cuniculus", np.nan],
            "specificEpithet": [np.nan, np.nan, "paca", np.nan],
            "infraspecificEpithet": [np.nan, np.nan, "nelsoni", np.nan],
            "taxonRank": [np.nan, np.nan, "subspecies", "family"],
            "scientificNameAuthorship": [np.nan, np.nan, np.nan, np.nan],
            "vernacularName": [np.nan, np.nan, "Spotted Paca", "Cricetidae Family"],
            "accessRights": ["CC-BY-NC", "CC-BY-NC", "CC-BY-NC", "CC-BY-NC"],
            "associatedMedia": [
                "gs:/bc6.JPG",
                "gs:/bc5.JPG",
                "gs:/a19.JPG",
